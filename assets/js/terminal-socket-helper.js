...
connError = () => main.error("You are currenlty offline."),
checkConnectivity = (callback, fallback) => {
...
socket.on("disconnect", () => {
    main.error("Connection Lost with " + socket.id).set_prompt("> ");
    $("title").text("🔴 Offline");
});
